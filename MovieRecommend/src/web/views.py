...
def task():
	global prediction_matrix,Ymean
	while 1:
		prediction_matrix,Ymean = Myrecommend()
...
def index(request):
	...
	movies = Movie.objects.all()[ran1:ran1+48]
...
def detail(request,movie_id):
	...
	if request.method == "POST":
		...
		print("redirect(index):" + str(redirect("index")))
...
#     return render(request, 'web/base.html', {'nowtime':times})
